...
@Component({
  selector: 'app-chart-dialog-edit',
  templateUrl: './chart-dialog-edit.component.html',
  styleUrl: './chart-dialog-edit.component.css'
})
export class ChartDialogEDitComponent  implements OnInit{
  constructor(
    public dialogRef: MatDialogRef<ChartDialogEDitComponent>,
